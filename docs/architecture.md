...
- Системный промпт первого ассистента требует строгой валидации фактов, допускает меньше 2 абзацев при недостатке данных, исключает блоки org_info без данных и задает приоритет PDF при расхождениях.
